    ...
    return (
        <div className="home d-flex justify-content-center">
            <div className="mx-auto">
                ...
                <h6 style={{fontSize: '18px'}} className="mt-4 px-2 mb-0 font-weight-bold">I'm <span className="text-success">Md. Mehedi Hasan Khan</span>,</h6>
                <div style={{fontSize: '28px'}} className="px-2"><small className="my-0 py-0 font-weight-bold text-warning">
                    <Typewriter
                        options={{
                ...
                <div className="row mx-auto">
                    <div className="col-md-4 d-flex justi p-2ontent-start">
